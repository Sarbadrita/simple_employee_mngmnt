...
con = mysql.connector.connect(host='localhost',database='employee',user='root',password='root',auth_plugin='mysql_native_password')
...
def menu():
    ...
    if ch == 1:
        ...
        system("cls")
        print("{:>60}".format("get the fuck out of here :)"))
        exit(0)
    else:
